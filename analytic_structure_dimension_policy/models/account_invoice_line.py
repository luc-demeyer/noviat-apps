...
class AccountInvoiceLine(models.Model, EnforcePolicy):
    """
    ...
    def _validate_analytic_fields(self, analytic):
        ...
        """
        for ail in self:
            ail._enforce_account_type_policy(
                analytic, policy=ail.analytic_dimension_policy)
        super(AccountInvoiceLine, self)._validate_analytic_fields(analytic)
