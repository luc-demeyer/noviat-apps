...
class AccountInvoiceTax(models.Model, EnforcePolicy):
    """
    ...
    def _validate_analytic_fields(self, analytic):
        ...
        """
        for ait in self:
            ait._enforce_account_type_policy(
                analytic, policy=ait.analytic_dimension_policy)
        super(AccountInvoiceTax, self)._validate_analytic_fields(analytic)
