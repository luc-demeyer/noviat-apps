...
class AccountPartnerOpenItemsXlsx(AbstractReportXlsx):
    ...
    def _get_ws_params(self, workbook, data, wiz):
            ...
            if lines:
                ...
                for p in p_map:
                    ...
                    if p['p_id'] not in map(
                        ...
                        original_amounts = map(
                            lambda x: x['amount_original'], partner_lines)
                        ...
                        reconciled_amounts = map(
                            lambda x: x['amount_reconciled'], partner_lines)
    ...
    def _empty_report(self, workbook, ws, ws_params, data, wiz):
        row_pos = 0
    ...
    def _overview_report(self, workbook, ws, ws_params, data, wiz):
    ...
    def _details_report(self, workbook, ws, ws_params, data, wiz):
...
AccountPartnerOpenItemsXlsx(
    'report.account_partner_open_items',
    'wiz.partner.open.items',
