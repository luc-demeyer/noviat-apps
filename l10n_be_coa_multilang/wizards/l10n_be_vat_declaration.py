...
class l10nBeVatDeclarationCase(models.TransientModel):
    ...
    sequence = fields.Integer(
        related='case_id.sequence', store=True)
...
class l10nBeVatDetailXlsx(models.AbstractModel):
    ...
    def _define_formats(self, wb):
        ...
        """
        super(l10nBeVatDetailXlsx, self)._define_formats(wb)
        ...
        self.format_tcell_top_grey_left = wb.add_format(
            dict(border, align='left'))
        self.format_tcell_top_grey_left.set_bottom(0)
        self.format_tcell_top_grey_center = wb.add_format(
        ...
        self.format_tcell_top_black_left = wb.add_format(
            dict(border, align='left'))
        self.format_tcell_top_black_left.set_bottom(0)
        self.format_tcell_top_black_center = wb.add_format(
            dict(border, align='center'))
        ...
        for aml in amls:
            ...
            if new_am and am_cnt > 1:
                ...
                format_tcell_amount_right = \
                    self.format_tcell_top_black_amount_right
                ...
                format_tcell_amount_right = \
                    self.format_tcell_top_grey_amount_right
