...
class l10nBeVatDeclaration(models.TransientModel):
    ...
    def create_detail_xls(self):
        module = __name__.split('addons.')[1].split('.')[0]
        report_name = '%s.report_l10n_be_vat_detail_xlsx' % module
        report = {
            'type': 'ir.actions.report.xml',
            'report_type': 'xlsx',
            'report_name': report_name,
...
class l10nBeVatDetailXlsx(AbstractReportXlsx):
...
l10nBeVatDetailXlsx(
    'report.l10n_be_coa_multilang.report_l10n_be_vat_detail_xlsx',
    'l10n.be.vat.declaration',
    parser=report_sxw.rml_parse)
