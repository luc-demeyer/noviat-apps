...
class partner_vat(osv.osv_memory):
    ...
    def get_partner(self, cr, uid, ids, context=None):
        ...
        cr.execute("""SELECT sub1.name, sub1.vat, sub1.turnover, sub2.vat_amount
        ...
        for record in cr.dictfetchall():        
            ...
            record['turnover'] = record['turnover'] or 0.0
            record['vat_amount'] = record['vat_amount'] or 0.0            
...
""" % amount_data_begin
        ...
        if annual_listing_data['comments']:
            data_end = """
        
        <ns2:Comment>%(comments)s</ns2:Comment>""" % annual_listing_data
        else: 
            data_end = ''
...
report_sxw.report_sxw('report.partner.vat.listing.print', 'res.partner', 'addons/l10n_be_coa_multilang/wizard/l10n_be_partner_vat_listing.rml', parser=partner_vat_listing_print,header=False)
