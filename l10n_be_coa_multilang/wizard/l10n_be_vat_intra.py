...
report_sxw.report_sxw('report.partner.vat.intra.print', 'partner.vat.intra', 'addons/l10n_be_coa_multilang/wizard/l10n_be_vat_intra_print.rml', parser=vat_intra_print, header="internal")
